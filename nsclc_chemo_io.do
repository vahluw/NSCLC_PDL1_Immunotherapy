...
global psm "i.braf i.kras i.ecog0 i.ecog1 i.ecog2 i.ecog3 i.ecog4 i.nonsquamouscellcarcinoma pdl1  diagnosisyear ageatdiagnosis i.white i.asian i.black i.otherrace i.hispanicrace i.patientassistanceprogram i.othergovernmentalinsurance i.medicare i.selfpay i.medicaid i.commercialhealthplan i.noinsurance  i.stage3 i.stage4  i.academicmedicalcenter i.kidney_bool i.liver_bool i.connective_tissue_bool i.interstitiallungdisease  i.bonemetastases i.brainmetastases i.othercnsmetastases i.digestivesystemmetastases i.adrenalmetastases   i.antiinfectiveusepriortotreatment glucocorticoidusepriortotreatmen pdl1reported"



global indiv_covar_psm_prog_outcome "i.braf i.kras i.ecog0 i.ecog1 i.ecog2 i.ecog3 i.ecog4 i.nonsquamouscellcarcinoma pdl1  diagnosisyear ageatdiagnosis i.white i.asian i.black i.otherrace i.hispanicrace i.patientassistanceprogram i.othergovernmentalinsurance i.medicare i.selfpay i.medicaid i.commercialhealthplan i.noinsurance  i.stage3 i.stage4  i.academicmedicalcenter i.kidney_bool i.liver_bool i.connective_tissue_bool i.interstitiallungdisease  i.bonemetastases i.brainmetastases i.othercnsmetastases i.digestivesystemmetastases i.adrenalmetastases   i.antiinfectiveusepriortotreatment glucocorticoidusepriortotreatmen i.diabetes i.male"
...
logit therapy_type ${indiv_covar_psm_prog_outcome}    
predict yhat
tab therapy_type
...
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${indiv_covar_psm_prog_outcome})  if pdl1>=0.5, osample(violators)
drop if violators==1
teffects ipwra (progression_outcome) (therapy_type) if pdl1>=0.5 
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${indiv_covar_psm_prog_outcome})  if pdl1>=0.5
//teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}, logit) (therapy_type ${indiv_covar_psm_prog_outcome})  if pdl1>=0.5 
tebalance summarize
tebalance summarize, baseline
...
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${indiv_covar_psm_prog_outcome})  if pdl1>=0.4

teffects ipwra (progression_outcome ) (therapy_type )  if pdl1>=0.6
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${indiv_covar_psm_prog_outcome})  if pdl1>=0.6

teffects ipwra (progression_outcome ) (therapy_type )  if pdl1>=0.7
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${indiv_covar_psm_prog_outcome})  if pdl1>=0.7

teffects ipwra (progression_outcome ) (therapy_type )  if pdl1>=0.8
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${indiv_covar_psm_prog_outcome})  if pdl1>=0.8

drop if connective_tissue_bool==1 | adrenalmetastases==1
teffects ipwra (progression_outcome ) (therapy_type )  if pdl1>=0.9
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${indiv_covar_psm_prog_outcome})  if pdl1>=0.9

teffects ipwra (progression_outcome ) (therapy_type )  if pdl1>=1
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${indiv_covar_psm_prog_outcome})  if pdl1>=1


drop if hispanicrace==1 | antiinfectiveusepriortotreatment==1
teffects ipwra (progression_outcome ) (therapy_type )  if pdl1==0 & pdl1reported==1
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${indiv_covar_psm_prog_outcome})  if pdl1==0 & pdl1reported==1

teffects ipwra (progression_outcome ) (therapy_type )  if pdl1>=0.01
...
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${indiv_covar_psm_prog_outcome})  if pdl1>=0.2

teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${indiv_covar_psm_prog_outcome})  if pdl1>=0.1

teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${indiv_covar_psm_prog_outcome})  if pdl1>=0.01

teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${indiv_covar_psm_prog_outcome})  if pdl1>=0.01 & pdl1 <=0.6
...
drop if antiinfectiveusepriortotreatment==1 | hispanicrace==1 | othercnsmetastases==1
tab therapy_type if pdl1==0.0 & pdl1reported==1
teffects ipwra (progression_outcome) (therapy_type) if pdl1==0.0 & pdl1reported==1
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${indiv_covar_psm_prog_outcome}) if pdl1==0.0 & pdl1reported==1
tebalance summarize
tebalance summarize, baseline
...
teffects ipwra (mortality_outcome ${indiv_covar_psm_mort_outcome}) (therapy_type ${matching_covariates})
tebalance summarize
tebalance summarize, baseline
...
teffects ipwra (mortality_outcome ${indiv_covar_psm_mort_outcome}) (therapy_type ${matching_covariates}) if pdl1>=0.5
tebalance summarize
tebalance summarize, baseline
...
teffects ipwra (mortality_outcome ${indiv_covar_psm_mort_outcome}) (therapy_type ${matching_covariates}) if pdl1>=0.01 & pdl1 < 0.50
tebalance summarize
tebalance summarize, baseline
...
teffects ipwra (mortality_outcome ${indiv_covar_psm_mort_outcome}) (therapy_type ${matching_covariates}) if pdl1==0.0 & pdl1reported==1 
tebalance summarize
tebalance summarize, baseline
