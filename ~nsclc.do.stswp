...
//replace ageatdiagnosis = exp(ageatdiagnosis)
 //replace daysfromadvanceddiagnosistotreat = exp(daysfromadvanceddiagnosistotreat)
...
//teffects psmatch (progression_outcome ) (therapy_type ${covar_psm_logit_treatment}), nneighbor(1) caliper(0.05) control(0) generate(var6) 
