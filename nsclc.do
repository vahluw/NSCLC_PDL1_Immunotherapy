...
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${psm})  if pdl1>=0.5 
...
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}, logit) (therapy_type ${psm}) if pdl1>=0.01 & pdl1 < 0.50
tebalance summarize
tebalance summarize, baseline
