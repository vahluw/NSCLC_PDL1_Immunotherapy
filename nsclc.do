...
tab therapy_type
drop if 2.therapy_type#1.hispanicrace != 0

teffects ipwra (progression_outcome $indiv_covar_psm_prog_outcome, logit) (therapy_type $psm), vce(robust) control(0) osample(lol)
drop if lol==1
teffects ipwra (progression_outcome $indiv_covar_psm_prog_outcome, logit) (therapy_type $psm), vce(robust) control(0)
...
drop if digestivesystemmetastases==1
drop if  1.therapy_type#1.ecog4 != 0 | 1.therapy_type#1.connective_tissue_bool != 0  |  1.therapy_type#1.digestivesystemmetastases != 0
teffects ipwra (progression_outcome $indiv_covar_psm_prog_outcome, logit) (therapy_type $psm) if pdl1>=0.01 & pdl1<0.5, vce(robust) control(0) osample(lol4)
drop if lol4==1
...
tab therapy_type
drop if 0.therapy_type#1.hispanicrace != 0
...
drop if digestivesystemmetastases==1
drop if  1.therapy_type#1.ecog4 != 0 | 1.therapy_type#1.connective_tissue_bool != 0  |  1.therapy_type#1.digestivesystemmetastases != 0
drop if ecog4 == 1 | connective_tissue_bool== 1 | digestivesystemmetastases==1
teffects ipwra (progression_outcome $indiv_covar_psm_prog_outcome, logit) (therapy_type $psm) if pdl1>=0.01 & pdl1<0.5, vce(robust) control(0) osample(lol4)
drop if lol4==1
teffects ipwra (progression_outcome $indiv_covar_psm_prog_outcome, logit) (therapy_type $psm) if pdl1>=0.01 & pdl1<0.5, vce(robust) control(0) 
