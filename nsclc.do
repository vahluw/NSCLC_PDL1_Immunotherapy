...
global covar_psm_logit_treatment "ecog0 ecog1 ecog2 ecog3 ecog4 squamouscellcarcinoma nonsquamouscellcarcinoma pdl1 over_threshold hispanicethnicity  diagnosisyear ageatdiagnosis white asian black otherrace hispanicrace male daysfromadvanceddiagnosistotreat patientassistanceprogram othergovernmentalinsurance medicare selfpay medicaid commercialhealthplan noinsurance stage0 stage1 stage2 stage3 stage4 occult neversmoker  academicmedicalcenter kidney_bool liver_bool connective_tissue_bool interstitiallungdisease diabetes bonemetastases brainmetastases othercnsmetastases digestivesystemmetastases adrenalmetastases unspecifiedmetastases   antiinfectiveusepriortotreatment glucocorticoidusepriortotreatmen braf kras pdl1reported "
	

global indiv_covar_psm_reported_outcome " ecog0 ecog1 ecog2 ecog3 ecog4 squamouscellcarcinoma nonsquamouscellcarcinoma pdl1   diagnosisyear ageatdiagnosis white asian black otherrace hispanicrace male daysfromadvanceddiagnosistotreat patientassistanceprogram othergovernmentalinsurance medicare selfpay medicaid commercialhealthplan noinsurance stage0 stage1 stage2 stage3 stage4 occult neversmoker  academicmedicalcenter kidney_bool liver_bool connective_tissue_bool interstitiallungdisease diabetes bonemetastases brainmetastases othercnsmetastases digestivesystemmetastases adrenalmetastases unspecifiedmetastases   antiinfectiveusepriortotreatment glucocorticoidusepriortotreatmen braf kras pdl1reported"

global indiv_covar_psm_prog_outcome " ecog0 ecog1 ecog2 ecog3 ecog4 squamouscellcarcinoma nonsquamouscellcarcinoma pdl1   diagnosisyear ageatdiagnosis white asian black otherrace hispanicrace male daysfromadvanceddiagnosistotreat patientassistanceprogram othergovernmentalinsurance medicare selfpay medicaid commercialhealthplan noinsurance stage0 stage1 stage2 stage3 stage4 occult neversmoker  academicmedicalcenter  diabetes bonemetastases brainmetastases othercnsmetastases digestivesystemmetastases adrenalmetastases unspecifiedmetastases   antiinfectiveusepriortotreatment glucocorticoidusepriortotreatmen braf kras pdl1reported"

global indiv_covar_psm_mort_outcome " ecog0 ecog1 ecog2 ecog3 ecog4 squamouscellcarcinoma nonsquamouscellcarcinoma pdl1   diagnosisyear ageatdiagnosis white asian black otherrace hispanicrace male daysfromadvanceddiagnosistotreat patientassistanceprogram othergovernmentalinsurance medicare selfpay medicaid commercialhealthplan noinsurance stage0 stage1 stage2 stage3 stage4 occult neversmoker  academicmedicalcenter  diabetes bonemetastases brainmetastases othercnsmetastases digestivesystemmetastases adrenalmetastases unspecifiedmetastases   antiinfectiveusepriortotreatment glucocorticoidusepriortotreatmen braf kras pdl1reported kidney_bool liver_bool connective_tissue_bool interstitiallungdisease diabetes"
...
logit therapy_type ${covar_psm_logit_treatment}    
predict yhat
...
drop if othercnsmetastases == 1
tab therapy_type
teffects ipwra (progression_outcome) (therapy_type)
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${covar_psm_logit_treatment}) 
teffects ipw (progression_outcome) (therapy_type ${covar_psm_logit_treatment})


drop if hispanicrace==1 | othercnsmetastases==1
tab therapy_type if pdl1>=0.5
teffects ipwra (progression_outcome) (therapy_type) if pdl1>=0.5 
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${covar_psm_logit_treatment}) if pdl1>=0.5 
teffects ipw (progression_outcome ) (therapy_type ${covar_psm_logit_treatment}) if pdl1>=0.5 

tab therapy_type if pdl1>=0.01 & pdl1 < 0.50
teffects ipwra (progression_outcome) (therapy_type) if pdl1>=0.01 & pdl1<0.5
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${covar_psm_logit_treatment}) if pdl1>=0.01 & pdl1 < 0.50
teffects ipw (progression_outcome) (therapy_type ${covar_psm_logit_treatment}) if pdl1>=0.01 & pdl1 < 0.50

drop if antiinfectiveusepriortotreatment==1
tab therapy_type if pdl1==0.0 & pdl1reported==1
teffects ipwra (progression_outcome) (therapy_type) if pdl1==0.0 & pdl1reported==1
teffects ipwra (progression_outcome ${indiv_covar_psm_prog_outcome}) (therapy_type ${covar_psm_logit_treatment}) if pdl1==0.0 & pdl1reported==1
teffects ipw (progression_outcome) (therapy_type ${covar_psm_logit_treatment}) if pdl1==0.0 & pdl1reported==1
...
teffects ipwra (mortality_outcome ) (therapy_type )
teffects ipwra (mortality_outcome ${indiv_covar_psm_mort_outcome}) (therapy_type ${covar_psm_logit_treatment})
teffects ipw (mortality_outcome) (therapy_type ${covar_psm_logit_treatment})

drop if othercnsmetastases==1
teffects ipwra (mortality_outcome ) (therapy_type) if pdl1>=0.5
teffects ipwra (mortality_outcome ${indiv_covar_psm_mort_outcome}) (therapy_type ${covar_psm_logit_treatment}) if pdl1>=0.5
teffects ipw (mortality_outcome ) (therapy_type ${covar_psm_logit_treatment}) if pdl1>=0.5

tab therapy_type  if pdl1>=0.01 & pdl1 < 0.50
teffects ipwra (mortality_outcome ) (therapy_type) if pdl1>=0.01 & pdl1 < 0.50
teffects ipwra (mortality_outcome ${indiv_covar_psm_mort_outcome}) (therapy_type ${covar_psm_logit_treatment}) if pdl1>=0.01 & pdl1 < 0.50
teffects ipw (mortality_outcome) (therapy_type ${covar_psm_logit_treatment}) if pdl1>=0.01 & pdl1 < 0.50

tab therapy_type  if pdl1==0.0 & pdl1reported==1 
teffects ipwra (mortality_outcome ) (therapy_type) if pdl1==0.0 & pdl1reported==1 
teffects ipwra (mortality_outcome ${indiv_covar_psm_mort_outcome}) (therapy_type ${covar_psm_logit_treatment}) if pdl1==0.0 & pdl1reported==1 
teffects ipw (mortality_outcome) (therapy_type ${covar_psm_logit_treatment}) if pdl1==0.0 & pdl1reported==1 
////////////////////////////////////////////////////////////////////////////////
/*


pstest ${covar_psm_logit_treatment}, raw treated(therapy_type)

psmatch2 therapy_type  ${covar_psm_logit_treatment} , outcome(endpoint) caliper(0.2) n(1) noreplacement 
count 
...
pstest ${covar_psm_logit_treatment} , treated(therapy_type)

stset censor_time, failure(progression_outcome)
 stci, by(therapy_type) rmean
 stcox therapy_type
 ...
 graph export "prog_chemo_io_post_match_prog.png", replace
  sts test therapy_type, logrank
...
logit therapy_type ${indiv_covar_psm_reported}    
predict yhat
...
graph export "propensity_post_match_hist_prog.png", replace
 ...
 replace censor_time = progression_days
 replace censor_time  = time_limit if censor_time == 0 | censor_time > time_limit
...
stset censor_time, failure(progression_outcome)
 ...
 stcox therapy_type
 sts graph, by(therapy_type) title("Progression-Free Survival for Entire Dataset") subtitle("by Therapy (Post-Matching)") xtitle ("Survival Time from Treatment Initiation (Days)") ytitle("Proportion at Risk") legend(order(1 "First-Line Chemotherapy" 2 "First-Line IO Monotherapy")) 
 graph export "prog_chemo_io_post_match.png", replace
  sts test therapy_type, logrank
  
   replace censor_time = mortality_days
 replace censor_time  = time_limit if censor_time == 0 | censor_time > time_limit 
 
  stset censor_time, failure(mortality_outcome)
 stci, by(therapy_type) rmean
 stcox therapy_type
 ...
 graph export "overall_chemo_io_post_match.png", replace
  sts test therapy_type, logrank
...
replace over_threshold = 1 if pdl1>=0.5
 ...
 sts graph, by(therapy_type) title("Progression-Free Survival for All Patients in Dataset") subtitle("by Therapy, Pre-Matching") xtitle ("Survival Time from Treatment Initiation  (Days)") ytitle("Proportion at Risk") legend(order(1 "First-Line Chemotherapy" 2 "First-Line IO Monotherapy")) 
  window manage forward results
 graph export "prog_survival_without_mutations_pre_match_no_combo_prog_over50.png", replace
 sts test therapy_type, logrank
...
drop if othercnsmetastases == 1
tab therapy_type
teffects psmatch (progression_outcome) (therapy_type ${covar_psm_logit_treatment}), nneighbor(4) caliper(0.1)
...
graph twoway (kdensity yhat if therapy_type==0) (kdensity yhat if therapy_type==1) ,ytitle("Propensity Score Density Pre-Matching") xtitle("Propensity Score") legend(label (1 "First-Line Chemotherapy") label(2 "First-Line IO Monotherapy"))
graph export "propensity_score_pre_matching_progression_over50.png", replace
...
graph twoway (histogram yhat if therapy_type==0, fcolor(blue%25) ///
		...
		label(2 "First-Line IO Monotherapy"))
window manage forward results
graph export "propensity_pre_match_hist_prog_over50.png", replace


pstest ${indiv_covar_psm_reported}, raw treated(therapy_type)
psmatch2 therapy_type  ${indiv_covar_psm_reported} , outcome(endpoint) caliper(0.01) n(1) noreplacement 
...
pstest ${indiv_covar_psm_reported} , treated(therapy_type)
...
graph twoway (histogram yhat if therapy_type==0, fcolor(blue%25) ///
		...
		subtitle("by Therapy Type, Entire Dataset") legend(label(1 "First-Line Chemotherapy") ///
		label(2 "IO Monotherapy")) 
graph export "propensity_post_match_hist_prog_over50.png", replace
...
stset censor_time, failure(progression_outcome)
 ...
 stcox therapy_type
 sts graph, by(therapy_type) title("Progression-Free Survival for Entire Dataset") subtitle("by Therapy (Post-Matching)") xtitle ("Survival Time from Treatment Initiation (Days)") ytitle("Proportion at Risk") legend(order(1 "First-Line Chemotherapy" 2 "First-Line IO Monotherapy")) 
 graph export "prog_chemo_io_post_match_over50.png", replace
  sts test therapy_type, logrank
 ...
 stcox therapy_type
 sts graph, by(therapy_type) title("Overall Survival for Entire Dataset") subtitle("by Therapy (Post-Matching)") xtitle ("Survival Time from Treatment Initiation (Days)") ytitle("Proportion at Risk") legend(order(1 "First-Line Chemotherapy" 2 "First-Line IO Monotherapy")) 
 graph export "overall_chemo_io_post_match_over50.png", replace
  sts test therapy_type, logrank
*/
