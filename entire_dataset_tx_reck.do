...
graph export "propensity_post_match_hist_prog_reck.png", replace
 ...
 graph export "chemo_io_post_match_pdl1_zero_prog_reck.png", replace
  sts test therapy_type, logrank
 ...
 graph export "chemo_io_post_match_pdl1_under50_prog_reck.png", replace
  sts test therapy_type, logrank
...
graph export "propensity_post_match_hist_mortality_reck.png", replace
 ...
 stci if pdl1==0.0 & pdl1_given==1, by(therapy_type) rmean
 stcox therapy_type if pdl1==0.0 & pdl1_given==1
 sts graph if pdl1==0.0 & pdl1_given==1, by(therapy_type) title("OverallSurvival for Entire Dataset (Confirmed PD-L1 Negative)") subtitle("by Therapy (Post-Matching)") xtitle ("Survival Time from Treatment Initiation (Days)") ytitle("Proportion at Risk") legend(order(1 "First-Line Chemotherapy" 2 "First-Line IO Monotherapy")) 
 graph export "chemo_io_post_match_pdl1_zero_mortality_reck.png", replace
  sts test therapy_type, logrank
 ...
 graph export "chemo_io_post_match_pdl1_under50_mortality_reck.png", replace
  sts test therapy_type, logrank
