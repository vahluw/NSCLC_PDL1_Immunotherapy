 ...
 ****************************
 ...
 stcox therapy_type
 sts graph, by(therapy_type) title("Progression-Free Survival for All Patients in Dataset") subtitle("by Therapy (Without Matching), Entire Dataset") xtitle ("Survival Time (Days)") ytitle("Proportion at Risk") 
